...
java -jar ../../antlr/antlr4-4.13.1-SNAPSHOT-complete.jar \
    -Dlanguage=TypeScript -o ./targets/antlr4-cpp-wasm -visitor -listener -package antlr4 -Xexact-output-dir -Werror \
    ./targets/antlr4-cpp-wasm/MySQLLexer.g4 ./targets/antlr4-cpp-wasm/MySQLParser.g4
